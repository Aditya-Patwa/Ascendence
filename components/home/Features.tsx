...
export default function Features() {
    return (
        <main className="mt-12 px-4 py-8 relative" id="products">
            <motion.div initial={{y: 20, opacity: 0, filter: "blur(4px)"}} whileInView={{y: 0, opacity: 1, filter: "blur(0px)"}} transition={{delay: .05, duration: .5, ease: "easeOut"}} className="grid justify-center gap-2">
                <div>
