export default function HowItWorks() {
    return (
        <section className="my-8 py-16 bg-indigo-600 bg-[linear-gradient(to_right,#6366f1_1px,transparent_1px),linear-gradient(to_bottom,#6366f1_1px,transparent_1px)] bg-[size:24px_24px] grid">
            <div className="max-w-6xl w-full justify-self-center p-4 md:p-8">
                ...
                <div className="mt-2">
                    <h3 className="text-2xl font-light text-zinc-200">
