...
export default function GetStarted() {
    return (
        <section className="w-screen overflow-x-hidden min-h-screen grid relative px-4 py-24">
            ...
            <motion.div initial={{y: -20, opacity: 0}} whileInView={{opacity: 1, y: 0}} transition={{duration: .65}} className="absolute p-4 lg:px-16 z-30 max-w-6xl w-full justify-self-center">
            ...
            <motion.div initial={{y: 40, opacity: 0}} whileInView={{opacity: 1, y: 0}} transition={{duration: .65}}  className="max-w-sm w-full justify-self-center">
                ...
                <div className="px-4 grid gap-2 mt-8 pb-8 gap-2">
                    <div>
                        <input type="email" placeholder="Enter Email" className="bg-transparent border border-zinc-500 dark:border-zinc-600 text-black dark:text-white px-4 text-nowrap py-2 rounded-xl text-base lg:text-md font-light relative overflow-hidden flex gap-2 justify-center items-center w-full outline-none" />
                    </div>
                    <Link href={"/"} className="bg-transparent border border-zinc-500 dark:border-zinc-600 text-black dark:text-white px-4 text-nowrap py-2 rounded-xl text-base lg:text-md font-bold relative overflow-hidden flex gap-2 justify-center items-center">
                        <div
                            className="pointer-events-none absolute -inset-px opacity-0 transition duration-500"
